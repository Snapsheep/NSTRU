...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
    ...
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>โครงการชมรมนักศึกษา</span>
        </li>
    </ul>
    </div>
    <!-- line bar -->
    <h1 class="page-title"> โครงการและกิจกรรมชมรมนักศึกษา
        <small>(ตรวจสอบ)</small>
    </h1>
...
<tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td align="center"> <?php echo $data['PCLUBNAME']; ?> </td>
            <td align="center"> <?php echo $data['PDATE']; ?><br><?php echo $data['PDATE2']; ?> </td>
            <td align="center">
                <a href="project_detail/project_detail5.php?id=<?php echo $data['P_ID']; ?>"> เพิ่มเติม </a>
            </td>
            <td align="center">
                <?php
                    if($data['PSTATUS'] != 1 && ($_SESSION['TYPESTATUS'] == "แอดมิน" || $_SESSION['TYPESTATUS'] == "ชมรมนักศึกษา")){
                ?>
                <a href="edit/editproject5.php?id=<?php echo $data['P_ID']; ?>"> แก้ไข </a> | 
                <a href="delete/deleteproject5.php?id=<?php echo $data['P_ID']; ?>"> ลบ </a>
                <?php
                    } else {
                        echo "แก้ไข" . " | " . "ลบ";
                    }
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-left" role="menu">
                    <form metod="post">
                    <li>
                        <a href="Student-club.php?id=<?php echo $data['P_ID']; ?>&am=1"> ผ่าน </a>
                    </li>
                    <li>
                        <a href="Student-club.php?id=<?php echo $data['P_ID']; ?>&am=2"> ไม่ผ่าน </a>
                    </li>
                    ...
                    if($am == 1){
                        $sql = "UPDATE storage5 SET PSTATUS = '1' WHERE P_ID = '" . $id . "'";
                        $result = mysqli_query($link, $sql);
                        header("Location: Student-club.php");
                    } else if ($am == 2){
                        $sql = "UPDATE storage5 SET PSTATUS = '2' WHERE P_ID = '" . $id . "'";
                        $result = mysqli_query($link, $sql);
                        header("Location: Student-club.php");
                    }
                    ?>
