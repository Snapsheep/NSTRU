...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
    ...
    <ul class="page-breadcrumb">
    	<li>
      	...
      	<li>
          	<span>โครงการสภานักศึกษา</span>
      	</li>
	</ul>
	</div>
   	<!-- line bar -->
    <h1 class="page-title"> โครงการและกิจกรรมสภานักศึกษา
        <small>(ตรวจสอบ)</small>
    </h1>
...
<tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td align="center">
                <a href="project_detail/project_detail1.php?id=<?php echo $data['P_ID']; ?>"> เพิ่มเติม </a>
            </td>
            <td align="center">
                <?php
                    if($data['PSTATUS'] != 1 && ($_SESSION['TYPESTATUS'] == "แอดมิน" || $_SESSION['TYPESTATUS'] == "สภานักศึกษา")){
                ?>
                <a href="edit/editproject.php?id=<?php echo $data['P_ID']; ?>"> แก้ไข </a> | 
                <a href="delete/deleteproject.php?id=<?php echo $data['P_ID']; ?>"> ลบ </a>
                <?php
                    } else {
                        echo "แก้ไข" . " | " . "ลบ";
                    }
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-left" role="menu">
                    <form metod="post">
                    <li>
                        <a href="homeoutput1.php?id=<?php echo $data['P_ID']; ?>&am=1"> ผ่าน </a>
                    </li>
                    <li>
                        <a href="homeoutput1.php?id=<?php echo $data['P_ID']; ?>&am=2"> ไม่ผ่าน </a>
                    </li>
                    ...
                    if($am == 1){
                        $sql = "UPDATE storage1 SET PSTATUS = '1' WHERE P_ID = '" . $id . "'";
                        $result = mysqli_query($link, $sql);
                        header("Location: homeoutput1.php");
                    } else if ($am == 2){
                        $sql = "UPDATE storage1 SET PSTATUS = '2' WHERE P_ID = '" . $id . "'";
                        $result = mysqli_query($link, $sql);
                        header("Location: homeoutput1.php");
                    }
                    ?>
